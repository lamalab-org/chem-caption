...
CORE: Dict[str, str] = {
    ...
    "carbonate": "[*]-O-C(=O)-O-[*]",
    "carboxylic_anhydride": "[*]~[#6](=O)~[#8]~[#6](=O)~[*]",
...
BRANCHES: Dict[str, str] = {
    ...
    ## saturated
    "methyl": "[CH3]-[!#1;!O;!$([NX3](-[CH3])-[CH3]);!C,$([C;!X4,R,X4H0;!$(C(=O))]),$([CH;X4;!$([CH]([#1])([CH3])([CH3,$([CH2][CH3])])-[!C,$([C;!X4,R,X4H0]);!#1]);!$([CH]([#1])([CH3])([CH3])[CH2]-[!C,$([C;!X4,R,X4H0]);!#1]);!$([CH]([#1])([CH3])([CH3])[CH2][CH2]-[!C,$([C;!X4,R,X4H0]);!#1]);!$([CH]([#1])(O)C=O);!$([CH]([#1])([CH](N)C=O)[$([CH3]),$([CH2][CH3])]);!$([CH]([#1])([CH3])[CH2][CH](N)C=O)]);!$(C(-[CH3])(-[CH3])(-[CH3,$([CH2]-[CH3]),$([CH]([CH3])[CH3])])[!C,$([C;!X4,R,X4H0]);!#1]);!$(C(-[CH3])(-[CH3])(-[CH3])[CH2][!C,$([C;!X4,R,X4H0]);!#1]);!$(C(-[CH3])(-[CH3])=[CH]-[CH2]);!$(C(-[CH3])(=[CH2])[CH2][CH2][!C,$([C;!X4,R,X4H0]);!#1]);!$(C(=[CH2])([CH3])C=O);!$([cH0]1[cH][cH][cH][cH][cH0]1);!$([cH0]1[cH][cH][cH0][cH][cH]1);!$([cH0]1[cH][cH0][cH][cH][cH]1);!$([cH0]1[cH0]c([CH3])[cH]c([CH3])[cH]1);!$([cH0]1[cH]c([CH3])[cH0]c([CH3])[cH]1);!$([SX4](=O)(=O));!$([SX4+](-[O-])(=O));!$([SX4+2](-[O-])(-[O-]));!$([Si]([CH3])([CH3])[CH3]);!$([Si]([CH3])([CH3])C([CH3])([CH3])[CH3]);!$([Si]([CH3])([CH3])[CH]([CH3])[CH3]);!$([Si]([CH3])([CH3])[cH0]1[cH][cH][cH][cH][cH]1)]",
    ##!! "methyl" excludes: methoxy; dimethylamino; methoxymethyl; acetoxy; acetyl; methyls on t-butyl, t-pentyl, neopentyl, thexyl, prenyl; tolyls; mesyl; mesityl; methyls on TMS, TBDMS, etc.;
    ...
    "propylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    ...
    "butylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    ...
    "pentylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    ...
    "hexylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    "thexyl": "[CH3]-[CH](-[CH3])-C(-[CH3])(-[CH3])-[!#1]",
    "n-heptyl": "[CH3]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!C,$([C;!X4,R,X4H0]);!#1]",
    "heptylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    "n-octyl": "[CH3]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!C,$([C;!X4,R,X4H0]);!#1]",
    "octylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    "n-nonyl": "[CH3]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!C,$([C;!X4,R,X4H0]);!#1]",
    "nonylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
    "n-decyl": "[CH3]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!C,$([C;!X4,R,X4H0]);!#1]",
    "decylene": "[!#1;!C,$([C;!X4,H0])]-[CH2]--[CH2][CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[CH2]-[!#1;!C,$([C;!X4,H0])]",
...
MAIN_GROUP: Dict[str, Dict] = {
    ...
    "Boron": {
        ...
        "catecholborane": "[*]-B1-O-c2ccccc2-O-1",
        "pinnacolborane": "[*]-B1-O-C([CH3])([CH3])-C1([CH3])[CH3]",
    ...
    "Phosphorus": {
        ...
        "fluorophosphonite": "[PX3](-[#6,#1])(-O)-F",
        "halophosphonite": "[PX3](-[#6,#1])(-O)-[Cl,Br,IX1]",
        ...
        "fluorohosphoramidite": "[PX3](-O)(-[#7X3,$([NX2]=[CX3,PX4])])-F",
        "halophosphoramidite": "[PX3](-O)(-[#7X3,$([NX2]=[CX3,PX4])])-[Cl,Br,IX1]",
        ...
        "phosphinate": "[$([PX4]=O),$([PX4+]-[O-])](-[#6;!$(C#N)])(-[#6])-O-[!#1]",
        "cyano_phosphinate": "[$([PX4]=O),$([PX4+]-[O-])](-[CX2]#[NX1,NX2H+])(-[#6])-O-[!#1]",
        ...
        "phosphonate_di_substituted": "[$([PX4]=O),$([PX4+]-[O-])](-[#6;!$(C#N)])(-O-[!#1])-O-[!#1]",
        "cyano_phosphonate": "[$([PX4]=O),$([PX4+]-[O-])](-[CX2]#[NX1,NX2H+])(-O-[!#1])-O-[!#1]",
        ...
        "phosphonamidate": "[$([PX4]=O),$([PX4+]-[O-])](-[#6;!$(C#N)])(-O)-[#7X3,$([NX2]=[CX3,PX4])]",
        "phosphonamido_cyanidate": "[$([PX4]=O),$([PX4+]-[O-])](-[CX2]#[NX1,NX2H+])(-O)-[#7X3,$([NX2]=[CX3,PX4])]",
        ...
        "phosphono_fluoridate": "[$([PX4]=O),$([PX4+]-[O-])](-[#6,#1])(-O)-F",
        "phosphono_halidate": "[$([PX4]=O),$([PX4+]-[O-])](-[#6,#1])(-O)-[Cl,Br,IX1]",
        ...
        "fluorophosphate": "[$([PX4]=O),$([PX4+]-[O-])](-[O-,OX2])(-[O-,OX2])-F",
        "halophosphate": "[$([PX4]=O),$([PX4+]-[O-])](-[O-,OX2])(-[O-,OX2])-[Cl,Br,IX1]",
        "phosphoramidic_fluoridate": "[$([PX4]=O),$([PX4+]-[O-])](-[#7X3,$([NX2]=[CX3,PX4])])(-[O-,OX2])-F",
        "phosphoramidic_halidate": "[$([PX4]=O),$([PX4+]-[O-])](-[#7X3,$([NX2]=[CX3,PX4])])(-[O-,OX2])-[Cl,Br,IX1]",
        ...
        "iminophosphono_fluoridate": "[$([PX4]=[NX2]),$([PX4+]-[NX2-])](-[#6,#1])(-[O-,OX2])-F",
        "iminophosphono_halidate": "[$([PX4]=[NX2]),$([PX4+]-[NX2-])](-[#6,#1])(-[O-,OX2])-[Cl,Br,IX1]",
    ...
    "Sulfur": {
        ...
        "β-sultam": "[$([SX4](=O)=O),$([SX4+](=O)-[O-]),$([SX4+2](-[O-])-[O-])]1-[NX3]-[#6]~[#6]1",
        "γ-sultam": "[$([SX4](=O)=O),$([SX4+](=O)-[O-]),$([SX4+2](-[O-])-[O-])]1-[NX3]-[#6]~[#6]~[#6]1",
    ...
    "Halogen": {
        ...
        ## C(sp2)-X
        "alkenyl_fluoride": "C=[CX3]-F",
        "alkenyl_chloride": "C=[CX3]-Cl",
        "alkenyl_bromide": "C=[CX3]-Br",
        "alkenyl_iodide": "C=[CX3]-[IX1]",
        "aryl_fluoride": "c-F",
        "aryl_chloride": "c-Cl",
        "aryl_bromide": "c-Br",
        "aryl_iodide": "c-[IX1]",
...
HOMOAROMATICS: Dict[str, str] = {
    ...
    "Monocyclic": {
        ...
        "1,2,3-trisubstituted_benzene": "[!#1]-[cH0;!$(c1c(-[OH])cccc1-[OH]);!$(c1(-O)c(-O)cccc1-O)]1:[cH0;!$(c1c(-[OH])c(-[OH])ccc1)]:[cH]:[cH]:[cH]:[cH0;!$(c1c(-[OH])c(-[OH])ccc1)]:1",  # excludes pyrogallol, 2,3- and 2,6- dihydroxyphenyl
        "1,2,4-trisubstituted_benzene": "[cH0;!$(c1(-O)cc(-O)c(-O)cc1);!$(c1cc(-[$([OH]),$(O[CH3])])c(-[$([OH]),$(O[CH3])])cc1)]1:[cH]:[cH0;!$(c1c(-[OH])ccc(-[OH])c1)](-[!#1]):[cH0;!$(c1c(-[OH])cc(-[OH])cc1)]:[cH]:[cH]:1",  # excludes hydroxyquinol, 2,4- and 2,5- dihydroxyphenyls, 3,4- di(hydroxy/methoxy)phenyls
        "1,3,5-trisubstituted_benzene": "[!O]-[cH0;!$(c1cc(-[OH])cc(-[OH])c1)]1:[cH]:[cH0]:[cH]:[cH0]:[cH]:1",  # excludes phlorglucinol, 3,5-dihydroxyphenyl
        ...
        "biaryl": "[cX3H0,nX3;!$(c1cc~[#6]~c1);!$(c1c-cc-1);!$([cX3H0]1[c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)]1)]-[cX3H0,nX3;!$(c1cc~[#6]~c1);!$(c1c-cc-1);!$([cX3H0]1[c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)][c;!$(c~c1ccccc1);!$(c(:a)(:a):a)]1)]", # excludes biphenyl, biphenylene, fluorene, terphenyls
    ...
    "Phenol/Oxyphenyl": {
        ...
        ## mono-sub
        "o-hydroxyphenyl": "[!#1;!O]-[cH0]1:[cH0](-[OH]):[cH]:[cH]:[cH]:[cH]:1",  # excludes catechol
        ...
        "hydroquinone": "O-[cH0]1:[cH]:[cH]:[cH0](-O):[cH]:[cH]:1",
        "2,3-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH0](-[OH]):[cH0](-[OH]):[cH]:[cH]:[cH]:1",
        "2,4-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH0](-[OH]):[cH]:[cH0](-[OH]):[cH]:[cH]:1",
        "2,5-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH0](-[OH]):[cH]:[cH]:[cH0](-[OH]):[cH]:1",
        "2,6-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH0](-[OH]):[cH]:[cH]:[cH]:[cH0](-[OH]):1",
        "3,4-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH]:[cH0](-[OH]):[cH0](-[OH]):[cH]:[cH]:1",
        "3,5-dihydroxyphenyl": "[!#1;!O]-[cH0]1:[cH]:[cH0](-[OH]):[cH]:[cH0](-[OH]):[cH]:1",
        "3-methoxy-4-hydroxyphenyl": "[!$([CH2]);!$(C=O);!$([CH]=[CH]-C=O);!O]-[cH0]1:[cH]:[cH0](-O-[CH3]):[cH0](-[OH]):[cH]:[cH]:1",  # excludes vanillyl, vanilloyl, feruloyl
        "3-hydroxy-4-methoxyphenyl": "[!$([CH2]);!$(C=O);!O]-[cH0]1:[cH]:[cH0](-[OH]):[cH0](-O-[CH3]):[cH]:[cH]:1",  # excludes isovanillyl, isovanilloyl
        "3,4-dimethoxyphenyl": "[!$([CH2]);!$(C=O);!O]-[cH0]1:[cH]:[cH0](-O-[CH3]):[cH0](-O-[CH3]):[cH]:[cH]:1",  # excludes veratryl, veratroyl
        ...
        "hydroxyquinol": "O-[cH0]1:[cH]:[cH0](-O):[cH0](-O):[cH]:[cH]:1",
...
ALLSMART_NAMES: List[str] = (
    list(CORE.keys())
    + list(BRANCHES.keys())
    + list(MAIN_GROUP.keys())
    + list(HOMOAROMATICS.keys())
    + list(ALIPHATIC_RINGS.keys())
    + list(HETEROALIPHATIC_RINGS.keys())
    + list(OXO_RINGS.keys())
...
ALLSMART_SMARTS: List[str] = (
    ...
    + list(MAIN_GROUP.values())
    + list(HOMOAROMATICS.values())
    + list(ALIPHATIC_RINGS.values())
    + list(HETEROALIPHATIC_RINGS.values())
...
SMARTS_MAP: Dict[str, Dict[str, str]] = dict(
    core=CORE,
    branches=BRANCHES,
    main_group=MAIN_GROUP,
    homoaromatics=HOMOAROMATICS,
