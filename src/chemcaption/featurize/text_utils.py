...
TEXT_TEMPLATES = dict(
    single=[
        "The {PROPERTY_NAME} for the {REPR_SYSTEM} molecule `{REPR_STRING}` has a magnitude of {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} for the molecule represented by {REPR_SYSTEM} string `{REPR_STRING}` "
        "has a magnitude of {PROPERTY_VALUE}.",
        ...
        "The {PROPERTY_NAME} for the {REPR_SYSTEM} molecule `{REPR_STRING}` has a value of {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} for the molecule represented by {REPR_SYSTEM} string `{REPR_STRING}` "
        "has a value of {PROPERTY_VALUE}.",
        ...
        "The {REPR_SYSTEM} molecule represented with string`{REPR_STRING}` is characterized by the {PROPERTY_NAME}"
        " as {PROPERTY_VALUE}.",
    ],
    multiple=[
        "The {PROPERTY_NAME} have the respective magnitudes: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the respective magnitudes of: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the magnitudes {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have respective magnitudes {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have respective magnitudes of {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have magnitudes {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have respective magnitudes {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the following magnitudes {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have the following magnitudes respectively: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the following respective magnitudes {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the respective values: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the respective values of: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the values {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have respective values {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have respective values of {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have values {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have respective values {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the following values {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have the following values respectively: {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have the following respective values {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have been evaluated to be {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have been evaluated to have values of {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have been evaluated to have magnitudes of {PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have been evaluated to have the following values "
        "{PROPERTY_VALUE} respectively.",
        "The {PROPERTY_NAME} have been evaluated to have following magnitudes {PROPERTY_VALUE} "
        "respectively.",
        "The {PROPERTY_NAME} have been evaluated to have the following respective values {PROPERTY_VALUE}.",
        "The {PROPERTY_NAME} have been evaluated to have following respective magnitudes {PROPERTY_VALUE}.",
...
QA_TEMPLATES = dict(
    multiple=[
        "What are the values of the {PROPERTY_NAME} of {REPR_SYSTEM} molecule `{REPR_STRING}`?",
        "What are the values of {PROPERTY_NAME} of {REPR_SYSTEM} molecule `{REPR_STRING}`?",
    ...
    single=[
        "What is the value of the {PROPERTY_NAME} for {REPR_SYSTEM} molecule `{REPR_STRING}`?",
        "What is the value of {PROPERTY_NAME} of {REPR_SYSTEM} molecule `{REPR_STRING}`?",
        ...
        " what is the value of the {PROPERTY_NAME}?",
